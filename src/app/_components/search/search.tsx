      ...
      <div className="relative flex justify-center items-center border-none w-full bg-neutral rounded-2xl ml-4">
        <div className="flex items-center w-1/2 pr-4">
          ...
          <input
            id="teacher"
            type="search"
            className="pt-4 pb-4 pr-2 bg-neutral border-none outline-none w-[100%] text-sm text-neutral-shadow "
        ...
        <div className="flex items-center w-1/2">
          ...
          <input
            id="teacher"
            type="search"
            className="pt-4 pb-4 bg-neutral border-none outline-none w-[80%] text-sm text-neutral-shadow"
            placeholder="شهر ..."
          />
        </div>
      </div>
